<%@ Page Title="" Language="C#" MasterPageFile="~/DemoMaster.Master" AutoEventWireup="true" CodeBehind="RegistrarSalida.aspx.cs" Inherits="SitioWEB_FarmaciaBD.Transacciones.RegistrarSalida" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Principal" runat="server">
    ...
    <table>
                    ...
                    <caption>
                        <h2 class="tituloForm">Registrar Salida de Producto </h2>
                        <tr>
                            <td class="labelContenido">Ingrese fecha Salida:</td>
                            <td colspan="2" style="width: 100px; height: 21px">
                                <asp:TextBox ID="txtFecSal" runat="server" CssClass="TextBoxDerecha" Width="96px"></asp:TextBox>
                                <ajaxToolkit:CalendarExtender ID="txtFecSal_CalendarExtender" runat="server" Enabled="True" TargetControlID="txtFecSal" />
                            </td>
                        </tr>
                        <tr>
                            <td class="labelContenido">Seleccione Empleado:</td>
                            <td class="auto-style15" colspan="2">
                                <asp:DropDownList ID="cboEmpleado" runat="server" AutoPostBack="True" CssClass="DropDownList" OnSelectedIndexChanged="cboEmpleado_SelectedIndexChanged" Width="300px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="3">&nbsp;<asp:GridView ID="grDetalles" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" onrowcommand="grDetalles_RowCommand" ShowHeaderWhenEmpty="True" Width="1076px" OnSelectedIndexChanged="grDetalles_SelectedIndexChanged">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="cantidad" HeaderText="Cantidad Retirada" />
                                </Columns>
            ...
            <table style="border: Solid 3px #D55500;"
                ...
                <tr>
                    ...
                    <td align="left" class="auto-style18">
                        <asp:DropDownList ID="cboProducto" runat="server"  Width="192px" CssClass="DropDownList" OnSelectedIndexChanged="cboProducto_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left" class="auto-style8">
                        <asp:TextBox ID="txtCanSal" runat="server" Width="70px" CssClass="TextBoxDerecha"></asp:TextBox>
                        <ajaxToolkit:MaskedEditExtender ID="txtCanSal_MaskedEditExtender" runat="server" BehaviorID="txtCanPed_MaskedEditExtender" Century="2000" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder="" CultureTimePlaceholder="" Mask="999" MaskType="Number" TargetControlID="txtCanSal" />
                        &nbsp;</td>
                </tr>
                <tr>
               ...
               <asp:Panel ID="pnlOCompra" runat="server" CssClass="CajaDialogo" Style="display: normal;" Width="700px"> 
                        ...
                        <tr> 
                            <td align="center" class="auto-style4" > 
                                &nbsp;<asp:Label ID="Label1" runat="server" Text="Grabar Salida" /> 
                            </td> 
                            <td width="12%" class="center"> 
                ...
                <tr>
                    ...
                    <td class="auto-style3">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="Button2" runat="server" Text="Cancelar" Width="100px" CssClass="boton-new" OnClick="Button2_Click" />
                    </td>
                </tr>
